...
for n in range(1,11):
        ...
        # <span class="list_memo_count_span"> [6]</span>  
        ...
        # <img src="http://www.todayhumor.co.kr/board/images/list_icon_shovel.gif?2" alt="펌글" style="margin-right:3px;top:2px;position:relative"> </td>

        for item in list:
                try:
                    title = item.find('a').text.strip()  # 앞뒤 공백 제거
